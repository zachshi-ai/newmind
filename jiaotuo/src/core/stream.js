/**
 * 矫托流解析 —— 兼容 zhizhi / jiebi / zhengnian / jiubian / mingshi / xiangxiao / zhizu /
 * shefa / yuanyu / kaocheng / fangchuan / pingzhun / chengshi / huashui / yidao 的会话流格式。
 *
 ...
 * 诏账按「引笔时点之前」的最近带文之据对账（先判后录，见 yinzhang.js）。
 */
