/**
 * 安澜解析 —— 兼容 zhizhi / jiebi / zhengnian / weibing / jiubian / licheng / youya /
 * lunshi / dingfen / baihe / fayi / zhibi / yuli / duzhi / erbing / zhongshi / xiaoyan /
 * mingshi / jiyi / xiangxiao / zhizu / shenqu / shefa / yuanyu / shuitu / kaocheng /
 * hengfa / zhixing / fangchuan / pingzhun / chengshi / huashui / saowu / shihu / yidao /
 * jiaotuo / zhixia / chachu / suliu / zizhao / kuijing / huiji 的会话流格式。
 *
 ...
 * 非 tool_call/tool_result 的事件（turn_start/principal 等）忽略。
 * 本层判定只用流内序列（seq），不依赖时间戳；合审归并的 at 排序见 audit.js；
 * 波账在 judge 时按当时全流现算（record 只记账——judge 幂等）。
 */
