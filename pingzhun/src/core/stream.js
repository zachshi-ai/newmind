/**
 * 平准流解析 —— 兼容 zhizhi / jiebi / zhengnian / jiubian / mingshi / xiangxiao / zhizu / shefa / yuanyu / kaocheng / fangchuan 的会话流格式。
 *
 ...
 * 本层判定只用流内序列（seq），不依赖时间戳；读取的 result.content 是递变判定的
 * 旧本来源（流内取文，同全仓既例），写的 args.content 是末文本身。
 */
